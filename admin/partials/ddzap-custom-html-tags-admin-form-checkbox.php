<?php
    ...
    $form_action = admin_url( 'themes.php?page=ddzap-custom-html-tags-admin-menu' );
    $fields = [
        'enable' => [
        ...
        'delimiter-1' => [
            'label' => __('Checkbox Border', DDZAP_TEXT_DOMAIN),
            'type'  => 'delimiter'
        ],
        'text-offset' => [
        ...
        'delimiter-2' => [
	        'label' => __('Checkbox Flag', DDZAP_TEXT_DOMAIN),
	        'type'  => 'delimiter'
        ],
        'flag-width' => [
	        'label' => __('Width', DDZAP_TEXT_DOMAIN),
